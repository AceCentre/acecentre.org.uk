...
import { getLaunchpadProducts } from "../launchpad";
...
export const getAllProducts = async (
  ...
  if (includeLaunchpad) {
    const allLaunchProducts = await getLaunchpadProducts();
    const allProducts = [...allWooProducts, ...allLaunchProducts];
    return allProducts;
  } else {
