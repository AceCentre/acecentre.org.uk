...
const DESCRIPTIONS = {
  education:
    "Ace Centre courses exploring ways to support written communication and learning. Courses explore the resources available, skill development and assessment and implementation of appropriate solutions.",
  communication:
    "Ace Centre courses exploring Augmentative and Alternative Communication (AAC) that supports face-to-face communication. Courses explore the resources available, skill development and assessment and implementation of appropriate solutions.",
  access:
