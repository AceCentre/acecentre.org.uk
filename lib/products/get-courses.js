...
export const getCourseCount = async (req, res, user) => {
  const response = await clientRequest(req, res, GetCourseCount, {
    id: user.userId,
  });
...
export const getMyCourses = async (req, res, user) => {
  const response = await clientRequest(req, res, GetMyCourses, {
    id: user.userId,
  });
