  ...
  const expected = [
    {
      ...
      price: 0,
      variations: [
        { name: "Word", price: 0, instantDownloadAvailable: false },
        { name: "PDF", price: 0, instantDownloadAvailable: false },
      ],
      gallery: [],
      image: null,
      instantDownloadAvailable: false,
  ...
  const expected = [
    {
      ...
      name: "My super awesome product",
      variations: [
        { name: "Test", price: 80, instantDownloadAvailable: false },
      ],
      price: 80,
      gallery: [],
      image: null,
  ...
  const expected = [
    {
      ...
      variations: [
        { name: "Test", price: 80, instantDownloadAvailable: false },
        { name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: 80,
      gallery: [],
      image: null,
  ...
  const expected = [
    {
      ...
      name: "My super awesome product",
      variations: [
        { name: "Test", price: 10, instantDownloadAvailable: false },
        { name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: null,
      minPrice: 10,
  ...
  const expected = [
    {
      ...
      name: "My super awesome product",
      variations: [
        { name: "Test", price: 0, instantDownloadAvailable: false },
        { name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: null,
      minPrice: 0,
