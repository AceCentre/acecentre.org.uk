  ...
  const expected = [
    {
      ...
      variations: [
        { id: 2, name: "Word", price: 0, instantDownloadAvailable: false },
        { id: 3, name: "PDF", price: 0, instantDownloadAvailable: false },
      ],
      gallery: [],
      image: null,
      instantDownloadAvailable: false,
        ...
        nodes: [
          {
            ...
            variations: {
              nodes: [{ databaseId: 2, name: "Test", price: "80.00" }],
            },
          },
        ],
      },
        ...
        nodes: [
          {
            ...
            variations: {
              nodes: [
                { databaseId: 2, name: "Test", price: "80.00" },
                { databaseId: 3, name: "Test2", price: "80.00" },
              ],
            },
          },
        ],
  ...
  const expected = [
    {
      ...
      id: 1,
      variations: [
        { id: 2, name: "Test", price: 80, instantDownloadAvailable: false },
        { id: 3, name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: 80,
      gallery: [],
      image: null,
        ...
        nodes: [
          {
            ...
            variations: {
              nodes: [
                { databaseId: 2, name: "Test", price: "10.00" },
                { databaseId: 3, name: "Test2", price: "80.00" },
              ],
            },
          },
  ...
  const expected = [
    {
      ...
      name: "My super awesome product",
      variations: [
        { id: 2, name: "Test", price: 10, instantDownloadAvailable: false },
        { id: 3, name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: null,
      minPrice: 10,
        ...
        nodes: [
          {
            ...
            variations: {
              nodes: [
                { databaseId: 2, name: "Test", price: null },
                { databaseId: 3, name: "Test2", price: "80.00" },
              ],
            },
          },
  ...
  const expected = [
    {
      ...
      id: 1,
      variations: [
        { id: 2, name: "Test", price: 0, instantDownloadAvailable: false },
        { id: 3, name: "Test2", price: 80, instantDownloadAvailable: false },
      ],
      price: null,
      minPrice: 0,
