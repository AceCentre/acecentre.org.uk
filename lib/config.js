...
const configMap = {
  ...
  development: {
    isRuntime,
    // launchpadUrl: "https://launchpad.acecentre.org.uk",
    launchpadUrl: "http://localhost:4000",
    serviceFinderUrl: "http://localhost:4001/.netlify/functions/graphql",
  ...
  production: {
    ...
    redisOptions: {
      connectionString: redisConnectionString,
      // 5 minutes - Reduced for faster content updates
      ttl: 300,
    },
    slack: {
      token: slackToken,
...
module.exports.launchpadUrl = config.launchpadUrl;
