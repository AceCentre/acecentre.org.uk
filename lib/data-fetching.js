...
const logResult = (startTime, uniqueIdentifier, queryName, dataFetchType) => {
...
export const request = async (url, query, params) => {
  ...
  if (parsedResult) {
    ...
    logResult(startTime, uniqueIdentifier, queryName, "redis-hit");
    return parsedResult;
  }
  ...
  logResult(startTime, uniqueIdentifier, queryName, "network-request");
