...
export const rawLoader = ({ src }) => {
  let remoteUrl = src;

  const parsedUrl = decodeURIComponent(src).replace("+", "%20");
  if (parsedUrl.startsWith("/")) {
    remoteUrl = `https://acecentre.org.uk${src}`;
  }
...
// "https://res.cloudinary.com/ace-cloud/image/fetch/f_auto,c_limit,w_256,q_auto/https://acecentre.org.uk/nav-logo.png" // WORKING
// "https://res.cloudinary.com/ace-cloud/image/fetchf_auto,c_limit,w_256,q_auto/https://integration.acecentre.org.uk/nav-logo.png
