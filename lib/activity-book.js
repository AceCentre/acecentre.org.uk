...
// Mock guide templates - in a real implementation, these would come from an API
const mockGuideTemplates = [
  {
    ...
    level: 4,
    badgeText: "Level 4",
    mainImage: "/images/dancing-figures.png",
    sections: [
      {
        heading: "Easy, errorless scanning with two switches",
        body: "I use two talking switches to choose people to dance. This guide will help you set up and use this activity effectively.",
      },
      {
        heading: "What you'll need",
        body: "You'll need two talking switches for this to work. Make sure they are positioned comfortably for the user.",
        image: "/images/bigmack-switch.png",
      },
      {
        heading: "Setting up the activity",
        body: "Position the switches so the user can easily reach them. One switch should be for 'yes' and one for 'no'.",
      },
      {
        heading: "How to play",
        body: "Ask the user who they would like to dance with. They can use the switches to make their selection.",
      },
    ],
  },
  {
