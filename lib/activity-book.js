...
// GuideTemplate: { templateId: string; templateType: "guide"; title: string; activityType: string; category?: string; level?: number; badgeText?: string; mainImage?: string; sections: GuideSection[] }
...
export const getGuideCategories = async () => {
  ...
  return templates.map((template) => {
    return {
      ...
      templateActivityType: template.activityType,
      templateCategory: template.category || "",
      templateActivityTypeSlug: slugify(template.activityType),
