...
it("requests an auth token if we have a refresh token", async () => {
  ...
  const session = new MockSession({
    user: {
      refreshToken:
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczovL2ludGVybmFsLmFjZWNlbnRyZS5vcmcudWsiLCJpYXQiOjE2Mjc2NDQyNTUsIm5iZiI6MTYyNzY0NDI1NSwiZXhwIjoxNjU5MTgwMjU1LCJkYXRhIjp7fX0.Fl4eNTPzmxT_kX7r3juGADuQ6aJvKOaM8LE4bJubI8M",
    },
  });
