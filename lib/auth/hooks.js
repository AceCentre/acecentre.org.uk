      ...
      try {
        if (mailingList) {
          try {
            ...
            // Track successful newsletter signup during registration
            if (
              posthogLoaded &&
            ...
            // If we can't contact the CRM server we don't want to fail the register
            console.warn(error);
...
const ERRORS = {
  ...
  invalid_email: "Your email address or password is incorrect",
