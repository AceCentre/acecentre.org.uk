...
export default function EngineeringPage({ featuredStory }) {
  return (
    <>
      ...
      <main id="mainContent">
        <VideoWithCardCover
          src="/services/mentorship.jpg"
          alt="Four clinicians looking at an AAC device"
          heightClass={styles.coverHeight}
          imageClassName={styles.coverImage}
        >
          <h1 className={styles.cardTitle}>Mentoring and Supervision</h1>
            ...
            {({ onClick }) => (
              <div className={styles.cardButton}>
                <Button onClick={onClick}>
                  Enquire about Mentoring and Supervision
                </Button>
              </div>
            )}
          </FormModal>
